...
OpenJobObjectFlags = ((1, "dwDesiredAccess", None),
                      (1, "bInheritHandles", None),
                      (1, "lpName", None))

OpenJobObject = OpenJobObjectProto(("OpenJobObjectW", windll.kernel32),
                                   OpenJobObjectFlags)
OpenJobObject.errcheck = ErrCheckHandle
